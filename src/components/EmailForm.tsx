...
<style type="text/css">
  #mc_embed_shell{display:flex; justify-content: center; align-items: center; align-content:center; align-self: center; }
      ...
      #mc-embedded-subscribe{
        ...
        box-shadow: 0 1px 17px 0 rgb(133, 85, 210);
        text-transform: none;
...
<div id="mc_embed_signup">
  ...
  <div aria-hidden="true" style="position: absolute; left: -5000px;">
      ...
      <input type="text" name="b_3df200657c4d416bfbbb3890e_987f78d24f" tabindex="-1" value="" class="email_input">
  </div>
      <div class="optionalParent">
          <div class="clear foot">
              <input type="submit" class="mc-embedded-subscribe" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
